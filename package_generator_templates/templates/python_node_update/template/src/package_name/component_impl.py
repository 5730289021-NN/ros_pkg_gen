...
class {apply-capitalized_comp_name}Data(object):
    """
    ...
    def __init__(self):
        """
        Definition of the {apply-capitalized_comp_name}Data attributes
        """
        {ifsubscriber}
        # input data
        {endifsubscriber}
    ...
    def __str__(self):
        msg = "Instance of {apply-capitalized_comp_name}Data class: \n {"
        {forallsubscriber}
